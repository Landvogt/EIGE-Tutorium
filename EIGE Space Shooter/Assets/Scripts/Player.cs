...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (amtToMove.x > 0)
        {
            transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(0, -30, 0), 0.3f);
        ...
        {
            Vector3 pos = new Vector3(transform.position.x, transform.position.y + (1f * transform.localScale.y),
